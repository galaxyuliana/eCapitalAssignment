...
* Implement the back-end API in .NET Framework or .NET Core, with an MS SQL Server database
...
* Implement API code to read and write to an MS SQL Server database
* Styling: CSS or SCSS can be used, whichever you prefer (can use popular UI frameworks like Bootstrap as well)
